...
class Point(object):
    ...
    def __key(self):
        return (self.name, tuple(self.coords), self.classification, self.alpha) 
        #self.coords must be tuple or else it won't hash, as a list of coordinates is mutable and a tuple of coordinates isn't.
