...
def probability_0_getargs() :  #TEST 44
    return [net_racoon.copy(), {'B':False}]
...
def probability_1_getargs() :  #TEST 45
    return [net_racoon.copy(), {'D':True}, dict(B=True, R=False, T=False)]
...
def probability_2_getargs() :  #TEST 46
    return [net_racoon.copy(), {'D':False}]
...
def probability_3_getargs() :  #TEST 47
    return [net_racoon.copy(), {'T':True, 'C':False}]
...
def probability_4_getargs() :  #TEST 48
    return [net_racoon.copy(), {'B':True, 'R':True}, {'D':False, 'T':False}]
...
def probability_5_getargs() :  #TEST 49
    return [net_racoon.copy(), {v:False for v in 'BRDTC'}]
...
def probability_6_getargs() :  #TEST 50
    return [net_racoon.copy(), dict(B=False, R=False, D=True, T=False, C=True)]
...
def number_of_parameters_0_getargs() :  #TEST 51
...
def number_of_parameters_1_getargs() :  #TEST 52
...
def number_of_parameters_2_getargs() :  #TEST 53
...
def number_of_parameters_3_getargs() :  #TEST 54
...
def independent_0_getargs() :  #TEST 55
...
def independent_1_getargs() :  #TEST 56
...
def independent_2_getargs() :  #TEST 57
...
def independent_3_getargs() :  #TEST 58
...
def independent_4_getargs() :  #TEST 59
...
def independent_5_getargs() :  #TEST 60
...
def independent_6_getargs() :  #TEST 61
...
def independent_7_getargs() :  #TEST 62
...
def is_structurally_independent_0_getargs() :  #TEST 63
...
def is_structurally_independent_1_getargs() :  #TEST 64
...
def is_structurally_independent_2_getargs() :  #TEST 65
...
def is_structurally_independent_3_getargs() :  #TEST 66
...
def is_structurally_independent_4_getargs() :  #TEST 67
...
def is_structurally_independent_5_getargs() :  #TEST 68
...
def is_structurally_independent_6_getargs() :  #TEST 69
...
def is_structurally_independent_7_getargs() :  #TEST 70
...
def is_structurally_independent_8_getargs() :  #TEST 71
...
def is_structurally_independent_9_getargs() :  #TEST 72
    return [net_grandparents.copy(), 'GP1', 'GP2', {'C':True, 'P1':True, 'P2':True}]
is_structurally_independent_9_expected = True
...
def is_structurally_independent_10_getargs() :  #TEST 73
    return [net_basic_probs.copy(), 'C', 'B', {'A':False}]
...
def is_structurally_independent_11_getargs() :  #TEST 74
