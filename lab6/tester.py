...
SUBMISSION_DEADLINE = datetime(2021, 11, 4)
...
def encode_NeuralNet(net):
    return [net.inputs, net.neurons, list(map(encode_Wire, net.wires))]
def decode_NeuralNet(inputs, neurons, wires_encoded):
    return NeuralNet(inputs, neurons, list(map(decode_Wire, wires_encoded)))
