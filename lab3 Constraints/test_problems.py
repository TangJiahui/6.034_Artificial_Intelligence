...
# If you import these problems into your lab3.py, be sure to use .copy() to
...
CSP_one_var_assigned_unconstrained = CSP_ABC.copy() \
    .add_constraints([cons_AC_equal]).set_assignment('B',2)

CSP_some_vars_assigned_consistent = CSP_no_vars_assigned.copy() \
    .set_assignments([('B',3), ('C',1)])
...
CSP_empty_domain_with_constraint = CSP_empty_domain.copy() \
    .add_constraints([cons_AB_equal]).set_assignment('A',2)
