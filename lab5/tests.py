...
lab_number = 5 #for tester.py

def random_list(length, minval=-100, maxval=100):
    return [ random.randint(minval,maxval) for x in range(length) ]
...
def li_dicts_eq(li_d1, li_d2):
    try:
        assert len(li_d1) == len(li_d2)
        h1 = sorted([hash(frozenset(d.items())) for d in li_d1])
        h2 = sorted([hash(frozenset(d.items())) for d in li_d2])
        return h1 == h2
    except Exception:
        return False
...
def split_on_classifier_1_testanswer(val, original_val = None) :
    try:
        assert len(val) == 1
        return li_dicts_eq(val['Yes'], tree_data)
    except Exception:
        return False
make_test(type = 'FUNCTION_ENCODED_ARGS',
...
def split_on_classifier_2_testanswer(val, original_val = None) :
    try:
        assert len(val) == 2
        assert li_dicts_eq(val["Oak"], tree_data[:3])
        assert li_dicts_eq(val["Maple"], tree_data[3:])
        return True
    except Exception:
        return False
make_test(type = 'FUNCTION_ENCODED_ARGS',
...
def split_on_classifier_3_testanswer(val, original_val = None) :
    try:
        assert len(val) == 2
        assert li_dicts_eq(val['No'], angel_data[:4])
        assert li_dicts_eq(val['Yes'], angel_data[4:])
        return True
    except Exception:
        return False
make_test(type = 'FUNCTION_ENCODED_ARGS',
...
def split_on_classifier_4_testanswer(val, original_val = None) :
    try:
        assert len(val) == 3
        assert li_dicts_eq(val['Smooth'], tree_data[4:6])
        assert li_dicts_eq(val['Glossy'], tree_data[0:1])
        assert li_dicts_eq(val['Furrowed'], tree_data[1:4])
        return True
    except Exception:
        return False
make_test(type = 'FUNCTION_ENCODED_ARGS',
...
def split_on_classifier_5_testanswer(val, original_val = None) :
    try:
        assert len(val) == 2
        assert li_dicts_eq(val[True], numeric_data[0:4]+numeric_data[5:8])
        assert li_dicts_eq(val[False], [numeric_data[4], numeric_data[8]])
        return True
    except Exception:
        return False
make_test(type = 'FUNCTION_ENCODED_ARGS',
...
def construct_greedy_id_tree_0_getargs() :  #TEST 29
...
def construct_greedy_id_tree_0t_getargs() :  #TEST 30
...
def construct_greedy_id_tree_1t_getargs() :  #TEST 31
...
def construct_greedy_id_tree_1_getargs() :  #TEST 32
    return [deepcopy(tree_data_furrowed), deepcopy(tree_classifiers), _ft_tt]
...
#tree_tree
def construct_greedy_id_tree_2_getargs() :  #TEST 33
...
def construct_greedy_id_tree_3_getargs() :  #TEST 34
...
#angel_tree
def construct_greedy_id_tree_4_getargs() :  #TEST 35
...
#numeric_tree
def construct_greedy_id_tree_5_getargs() :  #TEST 36
...
ANSWER_1_getargs = 'ANSWER_1'  #TEST 37
...
ANSWER_2_getargs = 'ANSWER_2'  #TEST 38
...
ANSWER_3_getargs = 'ANSWER_3'  #TEST 39
...
ANSWER_4_getargs = 'ANSWER_4'  #TEST 40
...
ANSWER_5_getargs = 'ANSWER_5'  #TEST 41
...
ANSWER_6_getargs = 'ANSWER_6'  #TEST 42
...
# accurate results.
ANSWER_7_getargs = 'ANSWER_7'  #TEST 43
...
ANSWER_8_getargs = 'ANSWER_8'  #TEST 44
...
ANSWER_9_getargs = 'ANSWER_9'  #TEST 45
...
#BOUNDARY_ANS_1
BOUNDARY_ANS_1_getargs = 'BOUNDARY_ANS_1'  #TEST 46
...
#BOUNDARY_ANS_2
BOUNDARY_ANS_2_getargs = 'BOUNDARY_ANS_2'  #TEST 47
...
#BOUNDARY_ANS_3
BOUNDARY_ANS_3_getargs = 'BOUNDARY_ANS_3'  #TEST 48
...
#BOUNDARY_ANS_4
BOUNDARY_ANS_4_getargs = 'BOUNDARY_ANS_4'  #TEST 49
...
#BOUNDARY_ANS_5
BOUNDARY_ANS_5_getargs = 'BOUNDARY_ANS_5'  #TEST 50
...
BOUNDARY_ANS_6_getargs = 'BOUNDARY_ANS_6'  #TEST 51
...
#BOUNDARY_ANS_7
BOUNDARY_ANS_7_getargs = 'BOUNDARY_ANS_7'  #TEST 52
...
BOUNDARY_ANS_8_getargs = 'BOUNDARY_ANS_8'  #TEST 53
...
BOUNDARY_ANS_9_getargs = 'BOUNDARY_ANS_9'  #TEST 54
...
#BOUNDARY_ANS_11
BOUNDARY_ANS_11_getargs = 'BOUNDARY_ANS_11'  #TEST 56
...
#BOUNDARY_ANS_12
BOUNDARY_ANS_12_getargs = 'BOUNDARY_ANS_12'  #TEST 57
...
#BOUNDARY_ANS_13
BOUNDARY_ANS_13_getargs = 'BOUNDARY_ANS_13'  #TEST 58
...
#BOUNDARY_ANS_14
BOUNDARY_ANS_14_getargs = 'BOUNDARY_ANS_14'  #TEST 59
...
## dot_product
def dot_product_0_getargs() :  #TEST 60
    return [(3, -7), [2.5, 10]]
...
def dot_product_1_getargs() :  #TEST 61
    return [[4], (5,)]
...
def dot_product_2_getargs() :  #TEST 62
...
## euclidean_distance
def euclidean_distance_0_getargs() :  #TEST 66
...
def euclidean_distance_1_getargs() :  #TEST 67
...
def euclidean_distance_2_getargs() :  #TEST 68
...
def euclidean_distance_2_testanswer(val, original_val = None) :
    return approx_equal(val,sum([(a_b1[0]-a_b1[1])**2 for a_b1 in zip(*euclidean_distance_2_random_inputs)])**0.5)
make_test(type = 'FUNCTION_ENCODED_ARGS',
...
def euclidean_distance_3_getargs() :  #TEST 69
...
def euclidean_distance_3_testanswer(val, original_val = None) :
    return approx_equal(val,sum([(a_b2[0]-a_b2[1])**2 for a_b2 in zip(*euclidean_distance_3_random_inputs)])**0.5)
make_test(type = 'FUNCTION_ENCODED_ARGS',
...
## manhattan_distance
def manhattan_distance_0_getargs() :  #TEST 70
    return [ Point((0,0)), Point((3,4)) ]
...
def manhattan_distance_1_getargs() :  #TEST 71
    return [ Point([-1,2,1], "A"), Point([-4,5,-2], "B") ]
...
def manhattan_distance_2_getargs() :  #TEST 72
...
def manhattan_distance_2_testanswer(val, original_val = None) :
    return val==sum([abs(a_b3[0]-a_b3[1]) for a_b3 in zip(*manhattan_distance_2_random_inputs)])
make_test(type = 'FUNCTION_ENCODED_ARGS',
...
## hamming_distance
def hamming_distance_0_getargs() :  #TEST 73
    return [ Point((0,0)), Point((3,4)) ]
...
def hamming_distance_1_getargs() :  #TEST 74
...
## cosine_distance
def cosine_distance_0_getargs() :  #TEST 76
...
def cosine_distance_1_getargs() :  #TEST 77
    return [ Point([-1,2,1], "A"), Point([-4,5,-2], "B") ]
...
def cosine_distance_2_getargs() :  #TEST 78
...
def cosine_distance_2_testanswer(val, original_val = None) :
    ...
    return approx_equal(val,1-1.*sum([a_b[0]*a_b[1] for a_b in zip(*p)])/reduce(lambda x,y:x*y,[sum([i**2 for i in v])**.5 for v in p],1))
make_test(type = 'FUNCTION_ENCODED_ARGS',
...
def get_k_closest_points_00_getargs() :  #TEST 79
...
def get_k_closest_points_0_getargs() :  #TEST 80
...
def get_k_closest_points_1_getargs() :  #TEST 81
...
def get_k_closest_points_2_getargs() :  #TEST 82
...
def get_k_closest_points_3_getargs() :  #TEST 83
...
#hamming_distance 1
def get_k_closest_points_4_getargs() :  #TEST 84
...
def get_k_closest_points_4a_getargs() :  #TEST 85
...
get_k_closest_points_5_expected = [Point((10, 15), "Maple"), Point((20, 30), "Maple"), Point((25, 40), "Maple"), Point((5, 10), "Maple"), Point((20, 40), "Oak"), Point((20, 15), "Oak"), Point((40, 30), "Oak")]
...
get_k_closest_points_6_expected = [Point([3], 'A'), Point([3], 'B'), Point([3], 'B'), Point([3], 'C'), Point([3], 'D')]
...
get_k_closest_points_7_expected = [Point([1,3,2], 'd'), Point([2,1,3], 'c')]
...
make_test(type = 'FUNCTION_ENCODED_ARGS',
          ...
          expected_val = str(get_k_closest_points_7_expected) + " (This test checks tie-breaking.)",
          name = 'get_k_closest_points')


## knn_classify_point
#euclidean_distance 3 Maple
def knn_classify_point_0_getargs() :  #TEST 89
    return [deepcopy(knn_tree_test_point), deepcopy(knn_tree_data), 3, euclidean_distance]
...
def knn_classify_point_1_getargs() :  #TEST 90
    return [deepcopy(knn_tree_test_point), deepcopy(knn_tree_data), 5, euclidean_distance]
...
def knn_classify_point_2_getargs() :  #TEST 91
    return [deepcopy(knn_tree_test_point), deepcopy(knn_tree_data), 3, manhattan_distance]
...
def knn_classify_point_3_getargs() :  #TEST 92
    return [deepcopy(knn_tree_test_point), deepcopy(knn_tree_data), 5, manhattan_distance]
...
def knn_classify_point_4_getargs() :  #TEST 93
    return [deepcopy(knn_tree_test_point), deepcopy(knn_tree_data), 1, hamming_distance]
...
def knn_classify_point_5_getargs() :  #TEST 94
...
def knn_classify_point_6_getargs() :  #TEST 95
    return [deepcopy(knn_tree_test_point), deepcopy(knn_tree_data), 7, cosine_distance]
...
#test with >2 classes
def knn_classify_point_7_getargs() :  #TEST 96
    return [Point([3], "D"), deepcopy(knn_toy_data), 5, euclidean_distance]
...
def cross_validate_0_getargs() :  #TEST 97
...
def cross_validate_1_getargs() :  #TEST 98
...
def cross_validate_2_getargs() :  #TEST 99
...
def cross_validate_3_getargs() :  #TEST 100
...
def cross_validate_4_getargs() :  #TEST 101
...
def find_best_k_and_metric_5_getargs() :  #TEST 102
...
#kNN_ANSWER_1
kNN_ANSWER_1_getargs = 'kNN_ANSWER_1'  #TEST 103
...
#kNN_ANSWER_2
kNN_ANSWER_2_getargs = 'kNN_ANSWER_2'  #TEST 104
...
#kNN_ANSWER_3
kNN_ANSWER_3_getargs = 'kNN_ANSWER_3'  #TEST 105
...
kNN_ANSWER_4_getargs = 'kNN_ANSWER_4'  #TEST 106
...
kNN_ANSWER_5_getargs = 'kNN_ANSWER_5'  #TEST 107
...
kNN_ANSWER_6_getargs = 'kNN_ANSWER_6'  #TEST 108
...
kNN_ANSWER_7_getargs = 'kNN_ANSWER_7'  #TEST 109
